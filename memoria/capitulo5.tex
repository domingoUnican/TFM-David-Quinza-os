...
unificada. El sistema utilizado fue macOS sobre el kernel Darwin. La
Tabla~\ref{tab:entorno_experimental} resume las principales versiones del
...
tiempo de pared desde el lanzamiento hasta la finalización del proceso, mientras
que el consumo de memoria se estimó mediante el máximo de memoria residente
...
\\
\\
Este comportamiento coincide con la interpretación de Pelofske. El algoritmo \textit{Binary Tree Batch GCD} resulta especialmente ventajoso cuando el número de factores compartidos es pequeño en comparación con el tamaño total del conjunto. A medida que aumenta el número de módulos débiles, la ventaja se reduce parcialmente, aunque el algoritmo sigue siendo claramente más eficiente que el enfoque clásico en todas las configuraciones evaluadas.
