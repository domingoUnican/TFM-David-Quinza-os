...
+ [Biased RSA private keys: origin attribution of GCD-factorable keys](https://www.usenix.org/conference/usenixsecurity12/technical-sessions/presentation/lenstra)
+ [Reaping and breaking keys at scale: when crypto meets big data](https://www.usenix.org/conference/usenixsecurity16/technical-sessions/presentation/heninger)
 [The mechanics of compromising low entropy RSA keys](https://www.usenix.org/conference/usenixsecurity19/presentation/filardo)
+ [Assessing the security of certificates at scale](https://www.usenix.org/conference/usenixsecurity14/technical-sessions/presentation/heninger)
+ [[Finding shared RSA factors in the Certificate Transparency logs](https://www.usenix.org/conference/usenixsecurity18/presentation/filardo)
+ [[An efficient all-to-all GCD algorithm for low entropy RSA Key Factorizacion](https://eprint.iacr.org/2022/1038)
